...
- (id)initWithCallSite:(KWCallSite *)aCallSite
         parentContext:(KWContextNode *)node
...
+ (id)contextNodeWithCallSite:(KWCallSite *)aCallSite
                parentContext:(KWContextNode *)contextNode
                  description:(NSString *)aDescription {
  return [[self alloc] initWithCallSite:aCallSite
                          parentContext:contextNode
...
- (void)performExample:(KWExample *)example
             withBlock:(void (^)(void))exampleBlock {
  ...
  void (^outerExampleBlock)(void) = ^{
    ...
    @catch (NSException *exception) {
      KWFailure *failure =
          [KWFailure failureWithCallSite:self.callSite
                                  format:@"%@ \"%@\" raised", [exception name],
                                         [exception reason]];
...
- (void)raiseIfNodeAlreadyExists:(id<KWExampleNode>)node {
  if (node) {
    [NSException raise:KWContextNodeException
                format:@"A %@ already exists in this context.",
